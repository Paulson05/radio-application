...
<div class="row py-lg-2">
    <div class="col-md-6 mt-5">
        <button class="btn btn-primary btn-lg float-md-left" role="button" aria-pressed="true">List of Cataegory</button>
    </div>
    <div class="col-md-6 mt-5">
        <a href="{{route('category.create')}}" class="btn btn-primary btn-lg float-md-right" role="button" aria-pressed="true">Create New Category</a>
    </div>
