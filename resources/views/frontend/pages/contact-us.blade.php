        ...
        <div class="row">
            <div class="col-lg-6">
                <form class="contact-form">
                    ...
                    <label class="contact-label">
                        <input type="text" placeholder="Your Email"><i class="fas fa-envelope"></i>
                    </label>
                    <label class="contact-label">
                        <input type="text" placeholder="Your Subject"><i class="fas fa-bookmark"></i>
                    </label>
                    <label class="contact-label">
                        <textarea placeholder="Your Message"></textarea><i class="fas fa-pen-nib"></i>
                    </label>
                    <button class="btn btn-inline"><i class="fas fa-paper-plane"></i><span>send message</span></button>
                </form>
            </div>
            <div class="col-lg-6">
